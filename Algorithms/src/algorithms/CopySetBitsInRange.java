 ...
 * For each set bits of y in range [l, r], set these bits in x also.
...
public class CopySetBitsInRange {
     ...
     * 
     * x = int to copy set bits into
     * lsb = least significant bit to start from
     * msb = most significant bit to end on
     * y = int to copy bits from
     * 
     * 
     * Input:
     * The first line of input contains an integer T denoting the number of test cases. 
     * Each test case contains space separated values of x, lsb, msb and y in a single line.
     * 
     * Output:
